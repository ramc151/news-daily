...
const News = (props) => {
    ...
    const updateNews = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&apiKey=29b6f88fe8744b7bad4286beed0bdb0d&category=${props.category}&page=${page}&pageSize=${props.pageSize}`;
        setLoading(true)
